...
def fc_forward(x, w, b):
    ...
    ###########################################################################
    out = np.dot(x, w) + b #the activation function x*w+b
    cache = (x, w, b)
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
...
def fc_backward(grad_out, cache):
    ...
    ###########################################################################
    x, w, b = cache
    grad_x = np.dot(grad_out, w.T) #computes the gradient of the loss with respect x
    grad_w = np.dot(x.T, grad_out) #computes the gradient of the loss with respect w
    grad_b = np.sum(grad_out, axis=0) #computes the gradient of the loss with respect to biases
...
def relu_forward(x):
    ...
    ###########################################################################
    out = np.maximum(0, x) #max (0,x) (relu)
    cache = x
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
...
def relu_backward(grad_out, cache):
    ...
    ###########################################################################
    x = cache
    grad_x = grad_out * (x > 0) #computes the gradient of the loss with respect to x
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
    return grad_x
...
def l2_regularization(w, reg):
    ...
    ###########################################################################
    loss = (reg / 2)*np.sum(w*w) #implementation of loss = (reg / 2) * sum_i w_i^2
    grad_w = reg * w #grad with respect to w
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
    return loss, grad_w
